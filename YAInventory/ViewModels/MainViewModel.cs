    ...
    public class MainViewModel : BaseViewModel
    {
        ...
        public async Task InitialiseAsync()
        {
            ...
            try
            {
                ...
                Notify($"DISCLAIMER : This software is a tool for billing and inventory management. Users are responsible for correct data entry, GST compliance, and tax filing. The developer is not liable for any financial or legal issues arising from its use.", "Info");
            }
            finally { ClearBusy(); }
        }
